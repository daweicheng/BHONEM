...
## 这里主要是将网络的edge_list表示形式，构建到graph类中，
    ...
    def read_edgelist(self, filename, weighted=False, directed=False):
        ...
        if directed:
            def read_unweighted(l):
                dst, src = l.split()     # i changed this part, becauce our data is directed and the direction is from the second column to the                                   # first column
